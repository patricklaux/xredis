...
public class LettuceClusterSyncOperator<K, V> implements RedisSyncOperator<K, V>, RedisAdvancedClusterCommands<K, V> {
    ...
    public RedisClusterCommands<K, V> getConnection(String nodeId) {
        return redisCommands.getConnection(nodeId);
    }

    @Override
    public RedisClusterCommands<K, V> getConnection(String host, int port) {
        return redisCommands.getConnection(host, port);
    }
