...
import com.igeeksky.redis.TimeConvertor;
import com.igeeksky.redis.api.Pipeline;
import com.igeeksky.redis.api.RedisOperator;
import com.igeeksky.redis.flow.Flow;
import com.igeeksky.redis.flow.RetryFlow;
...
public class StreamContainer<K, V> implements AsyncCloseable {
     ...
     */
    public StreamContainer(RedisOperator<K, V> operator, ScheduledExecutorService scheduler, long interval) {
