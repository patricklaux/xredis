...
public class ClientOptionsHelper {
    ...
    public static ClientOptions clientOptions(String id, Lettuce.ClientOptions clientOptions,
                                              List<ClientOptionsBuilderCustomizer> customizers) {

        ClientOptions.Builder builder = ClientOptions.builder();

        setClientOptionsBuilder(id, clientOptions, builder, customizers);

        customizers.forEach(c -> c.customizeClient(id, builder));
    ...
    public static ClusterClientOptions clusterClientOptions(String id, Lettuce.ClusterClientOptions clientOptions,
        ...
        customizers.forEach(c -> c.customizeClusterClient(id, builder));
        return builder.build();
    }
    ...
    private static void setClientOptionsBuilder(
            ...
            ClientOptions.Builder builder, List<ClientOptionsBuilderCustomizer> customizers) {
        ...
        customizers.forEach(c -> c.customizeTimeout(id, timeoutOptionsBuilder));
        builder.timeoutOptions(timeoutOptionsBuilder.build());

        customizers.forEach(c -> c.customizeSsl(id, sslOptionsBuilder));
