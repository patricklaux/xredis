...
import com.igeeksky.xredis.lettuce.props.Lettuce;
...
public abstract class ClientOptionsHelper {
     ...
     * 转换客户端选项
     * <p>
     * {@code com.igeeksky.xredis.lettuce.props.Lettuce.ClientOptions} 配置转换成 {@code io.lettuce.core.ClientOptions}
     *
     * @param id            客户端ID
     ...
     * 转换集群客户端选项
     * <p>
     * {@code com.igeeksky.xredis.lettuce.props.Lettuce.ClusterClientOptions} 配置转换成 {@code io.lettuce.core.ClusterClientOptions}
     *
     * @param id            客户端ID
     * @param clientOptions 客户端配置选项
     * @param customizers   客户端自定义选项
