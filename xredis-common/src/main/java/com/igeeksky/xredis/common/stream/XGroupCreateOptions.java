 ...
 */
public class XGroupCreateOptions {
     ...
     * @see <a href="https://redis.io/docs/latest/commands/xgroup-create/">XGROUP CREATE</a>
     */
    public static XGroupCreateOptions mkstream() {
        return new XGroupCreateOptions(true, null);
    }
     ...
     * @see <a href="https://redis.io/docs/latest/commands/xgroup-create/">XGROUP CREATE</a>
     */
    public static XGroupCreateOptions entriesRead(long entriesRead) {
        return new XGroupCreateOptions(false, entriesRead);
    }
     ...
     * @see <a href="https://redis.io/docs/latest/commands/xgroup-create/">XGROUP CREATE</a>
     */
    public static XGroupCreateOptions of(boolean mkstream, long entriesRead) {
        return new XGroupCreateOptions(mkstream, entriesRead);
    }
